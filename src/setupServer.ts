...
import { CustomError, IErrorResponse } from './shared/globals/helpers/error-handle';
...
export class TodoServer {
  ...
  public start(): void {
    ...
    this.standardMidddleware(this.app);
  ...
  private standardMidddleware(app: Application): void {
    app.use(compression());
